...
if vim.g.neovide then
  -- Check if markdown mappings are active
...
vim.keymap.set({'n'}, '<', function() require("nvim-treesitter-textobjects.select").select_textobject("@function.outer", "textobjects") end , {})
