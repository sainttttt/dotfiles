  ...
  {
    {
      ...
      config = function()
        ...
        vim.keymap.set("n", "ax", function() fzf_lua.lgrep_curbuf() end)
        ...
        vim.keymap.set("n", "<M-I>", function() fzf_lua.grep_cword() end)
        ...
        vim.keymap.set("n", "<M-U>", function() fzf_lua.resume() end)
